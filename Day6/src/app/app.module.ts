...
import {UniqueProductDirective} from './directives/app.uniqueproduct.directive';
import {SearchProductComponent} from './components/SearchProduct/app.searchproduct.component';
...
@NgModule({
  ...
  bootstrap: [ SearchProductComponent]
})
